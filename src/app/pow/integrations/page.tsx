  ...
  return (
    <div className={g.container} style={{ maxWidth: 1400, marginTop: 40, paddingBottom: 100 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid var(--border)', paddingBottom: 24, marginBottom: 40 }}>
        <div>
          <h1 style={{ fontFamily: 'var(--font-space)', fontSize: '2.5rem', margin: '0 0 8px 0', textTransform: 'uppercase', letterSpacing: '-0.03em' }}>Integrations</h1>
          <div style={{ fontFamily: 'var(--font-space)', fontSize: '0.9rem', color: 'var(--text-muted)' }}>Connect tools to automatically update your Grid Portfolio</div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', padding: 32 }}>
            <div style={{ fontFamily: 'var(--font-space)', fontSize: '1.2rem', fontWeight: 600, marginBottom: 16 }}>Privacy Settings</div>
            <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: 24 }}>
              Control what recruiters and other students can see on your public Grid Portfolio.
            </div>
            
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                <input type="radio" name="privacy" defaultChecked style={{ accentColor: 'var(--accent)', width: 16, height: 16 }} />
                <span style={{ fontFamily: 'var(--font-space)', fontSize: '0.9rem' }}>Public Portfolio (Recommended for hiring)</span>
              </label>
              <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
                <input type="radio" name="privacy" style={{ accentColor: 'var(--accent)', width: 16, height: 16 }} />
                <span style={{ fontFamily: 'var(--font-space)', fontSize: '0.9rem' }}>Hidden details (Show only top-level stats)</span>
              </label>
              <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer', opacity: 0.5 }}>
                ...
                <span style={{ fontFamily: 'var(--font-space)', fontSize: '0.9rem' }}>Private mode</span>
              </label>
            </div>
          </div>
        </div>
